...
<head>
  <meta charset="utf-8">
  <title>PORTAL BERITA UNS</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta content="" name="keywords">
  <meta content="" name="description">
<link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/UNS.png'?>">
  ...
  <header id="header">
    <div class="container-fluid">
      <div id="logo" class="pull-left">
      	<a class="h5co"><img src="assets/images/UNS V1.png" width="80px" height="80px"> </a>
  
    <h1>BERITA UNS</h1>
     <h3>BERITA SEPUTAR UNS</h3>
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Portal Berita UNS</h2>
		   					<h3><p>Ayo buat dan Portal Berita UNS terbaikmu </p></h3>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>NEWS BERITA UNS</h3>
          <p>BERITA SEPUTAR UNS DAN PRESTASI MAHASISWA
			</p>
        </header>
...
<!--            
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>PORTAL BERITA UNS</strong>. All Rights Reserved
      </div>
